    ...
    <div className="relative mb-20 mt-20">
      ...
      <div className="absolute inset-0 flex justify-between items-center z-10">
          ...
          <button onClick={prevImage} className='text-white
           bg-black p-3 rounded-lg px-5 ml-2  focus:outline-none'>
            <LeftOutlined style={{ fontSize: '24px' }} />
          </button>
          <button onClick={nextImage} className='text-white
           bg-black p-3 rounded-lg px-5 mr-2    focus:outline-none'>
            <RightOutlined style={{ fontSize: '24px' }} />
          </button>
        </div>
        <div className="absolute hidden top-0 left-0 right-0 lg:flex md:flex justify-center items-center z-10">
          <div className="flex space-x-20 h-20 bg-gray-200 rounded-lg">
            {/* bg-[#282828] */}
        ...
        <div className="absolute
         ...
         top-20 left-10 transform-translate-y-1/2
          ...
          {/* <div className='absolute top-1/2 left-5 lg:left-10 transform -translate-y-1/2'>
            <button onClick={prevImage} className='text-white 
            bg-black px-2 py-2 rounded-full
            focus:outline-none'>
              <LeftOutlined style={{ fontSize: '24px' }} />
            </button>
          </div>
          <div className='absolute top-1/2 right-5 lg:right-10 transform -translate-y-1/2'>
            <button onClick={nextImage} className='text-white focus:outline-none bg-black
